...
theme_bar_tissue <- base_theme + theme(axis.title.x = element_text(size = 20), axis.text.x = element_text(size = 20), plot.title = element_text(hjust = 0.5, size = 25))

### compute plots 
theme_compute_main <- base_theme + theme(axis.title.x = element_blank(), plot.margin = unit(c(0,0,1.2,1), "cm"))
theme_compute_tissue <- base_theme + theme(axis.title.x = element_blank(), axis.text.x = element_text(size = 20), plot.title = element_text(hjust = 0.5, size = 25), plot.margin = unit(c(0,0,1.2,1), "cm"))
