...
geneset_filtered_filtered = data.table::fread(paste0(REF_DIR, "Table_S2_255_genesets.csv"))
...
gene_set = gene_sets[!grepl("battle_|tgfb_|vhio|08283|rand", names(gene_sets))]
...
fwrite(geneset_names, paste0(REF_DIR, "T_cell_genesets.csv"))
...
fwrite(RNA_features, paste0(REF_DIR, "features_Tcell.csv"))
